...
// TODO: Adhoc task failed: local_lessonation\task\offlinegen,Class "local_lessonation\invalid_parameter_exception" not found
    ...
    public function execute() {
        ...
        if ($result['success']) {
            ...
            $lessonationrecord = $DB->get_record('local_lessonation',
                array('adhocid' => $this->get_id()), '*', MUST_EXIST);
