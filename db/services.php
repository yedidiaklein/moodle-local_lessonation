 ...
 * @category    admin
 * @copyright   2025 Yedidia Klein <yedidia@openapp.co.il>
...
$functions = [
    ...
    'local_lessonation_check_state' => [
        'classname'   => 'local_lessonation\external\check_state',
        'description' => 'Check state of lesson generation',
        'type'        => 'read',
        'ajax'        => true,
    ],
];
